...
const Register = ({ toggleForm }) => {
    return (
        <form className='max-w-[400px] w-full mx-auto bg-gray-800 text-white p-8 rounded-3xl'>
            <h2 className='text-4xl font-bold text-center py-4'>Agatka cyber security</h2>
            <div className='flex justify-between py-4'>
            </div>
            <div className='flex flex-col mb-4 '>
                <label>Username</label>
                <input className='border relative text-black dark:text-black text-lg p-2' type="text" />
            </div>
            <div className='flex flex-col mb-4'>
                <label>Email</label>
                <input className='border relative text-black dark:text-black text-lg p-2' type="email" />
            </div>
            <div className='flex flex-col mb-4'>
                <label>Password</label>
                <input className='border relative text-black dark:text-black text-lg p-2' type="password" />
            </div>
            <div className='flex flex-col mb-4'>
